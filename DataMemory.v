module DataMemory(
	...
	always @ (posedge clk) begin
		if(~rst) begin
			...
			data_memory[8] <= 8'b0;
			data_memory[9] <= 8'b0;
			data_memory[10] <= 8'b00001011;
			data_memory[11] <= 8'b00000011;
			data_memory[12] <= 8'b00000111;
			data_memory[13] <= 8'b00000110;
			data_memory[14] <= 8'b00000100;
			data_memory[15] <= 8'b00001000;
			data_memory[16] <= 8'b00000001;
			data_memory[17] <= 8'b00001100;
			data_memory[18] <= 8'b00001001;
			data_memory[19] <= 8'b00001010;
			data_memory[20] <= 8'b00000001;
			data_memory[21] <= 8'b00000010;
			data_memory[22] <= 8'b11111111;
			data_memory[23] <= 8'b00011100;
			data_memory[24] <= 8'b00001001;
			data_memory[25] <= 8'b00001000;
			data_memory[26] <= 8'b00001000;
			data_memory[27] <= 8'b00001010;
			data_memory[28] <= 8'b00010010;
			data_memory[29] <= 8'b00000111;
			data_memory[30] <= 8'b0;
			data_memory[31] <= 8'b0;
			data_memory[32] <= 8'b0;
			data_memory[33] <= 8'b0;
